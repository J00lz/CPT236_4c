...
*/
    ...
    // Routine:     compareTo()
    // Purpose:     Compare two MyEvent instances
    // Input:       otherEvent           2nd MyEvent instance
    // Output:      COMPARE_TO_LT (-1)  this.Event < otherEvent
    //              COMPARE_TO_EQ (0)   this.Event == otherEvent
    //              COMPARE_TO_GT (+1)  this.Event >- otherEvent
    ...
    //              Note - return true if ALL variables are "the same"
