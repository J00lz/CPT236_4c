...
public interface MyTimeInterface extends Comparable<MyTime>
{
    ...
    // Description: This function funtion validates the specified M/D/Y variables as a valid time
    ...
    // Output:      COMPARE_TO_LT (-1)  this.Time < otherTime
    ...
    // Output:      boolean         true (-- to be re-addressed --)
